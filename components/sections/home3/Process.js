          ...
          >
            <div className="inner-box">
              ...
              <div className="lower-content">
                ...
                <p>
                  Connect with our experts to discuss your business goals and
                  needs.{" "}
                </p>
              </div>
            </div>
          ...
          >
            <div className="inner-box">
              ...
              <div className="lower-content">
                ...
                <p>
                  Receive a customised plan for business setup, visas, or
                  attestation.{" "}
                </p>
              </div>
            </div>
          ...
          >
            <div className="inner-box">
              ...
              <div className="lower-content">
                ...
                <p>
                  Start your venture with full support in over 120 countries.{" "}
                </p>
              </div>
            </div>
          </div>
