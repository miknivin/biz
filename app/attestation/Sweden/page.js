  ...
  return (
    <>
      <Layout
        ...
        footerStyle={1}
        isAttestation={true}
        breadcrumbTitle="Sweden Certificate Attestation for UAE"
      >
        {/* about-section */}
                ...
                <div className="content_block_one">
                  <div className="content-box ml_30">
                    <div className="sec-title mb_15">
                      <h2>Sweden Certificate Attestation for UAE</h2>
                    </div>
                    <div className="text-box mb_40">
                      <p className="pb-4">
                        All the documents issued from the Sweden, such as
                        ...
                        thoSwedennds and thoSwedennds of US documents
                        attestation over the decade. Many people know that
                        attesting Sweden documents is a complicated process and
                      ...
                      <p className="pb-4">
                        ...
                        serving our clients who are especially having Sweden
                        documents authentication requirement for gulf countries
                        like UAE, Saudi Arabia (KSA),Kuwait and Qatar. Below are
                        the procedures to get Sweden documents attested, which
            ...
            <div className="container mt-4">
              <div className="row mb-4 pb-4">
                ...
                <div className="col-md-4 border-end">
                  <h3 className="text-dark mb-3">Sweden Personal Documents</h3>
                  <ul className="list-unstyled">
                    <li className="text-secondary mb-2">
                      Sweden Birth Certificate Attestation
                    </li>
                    <li className="text-secondary mb-2">
                      Sweden Marriage Certificate Attestation
                    </li>
                    <li className="text-secondary mb-2">
                      Sweden Death Certificate Attestation
                    </li>
                    <li className="text-secondary mb-2">
                      Sweden Medical Certificate Attestation
                    </li>
                    <li className="text-secondary mb-2">
                      Sweden Transfer Certificate Attestation
                    </li>
                    <li className="text-secondary mb-2">
                      Sweden Divorce Decree Attestation
                    </li>
                    <li className="text-secondary mb-2">
                      Sweden Power of Attorney Attestation
                    </li>
                    <li className="text-secondary mb-2">
                      Sweden Passport Attestation
                    </li>
                    <li className="text-secondary mb-2">
                      Sweden Birth Certificate Issuance
                    </li>
                    <li className="text-secondary mb-2">
                      Sweden Marriage Certificate Issuance
                    </li>
                  </ul>
                </div>
                ...
                <div className="col-md-4">
                  ...
                  <ul className="list-unstyled">
                    <li className="text-secondary mb-2">
                      Sweden Degree Attestation
                    </li>
                    <li className="text-secondary mb-2">
                      Sweden Master Degree Attestation
                    </li>
                    <li className="text-secondary mb-2">
                      Sweden Diploma Attestation
                    </li>
                    <li className="text-secondary mb-2">
